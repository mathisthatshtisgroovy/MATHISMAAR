...
@media (max-width: 768px) {
  ...
  /* Now playing cluster: bottom-center above circle */
  .now-playing-wrap {
    top: auto;
    right: auto;
    left: 50%;
  ...
  /* Keep it calm: hide text on phone (skip dot stays) */
  .now-playing-text {
    display: none;
  }

  /* Skip notice: follow the dock */
  .skip-notice {
    top: auto;
    right: auto;
    left: 50%;
  ...
  /* Reset icon: keep it accessible but not in the top chrome area */
  .reset-archive {
    top: auto;
    right: 18px;
    bottom: 24px;
